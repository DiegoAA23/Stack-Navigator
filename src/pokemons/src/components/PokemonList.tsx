...
import {View, Text,Image,Button,TouchableOpacity,useColorScheme,SafeAreaView,StatusBar, StyleSheet} from "react-native";
...
const PokemonList = () => {
    ...
    return(
        ...
        <View style={[styles.container,{backgroundColor: currentPokemon.color}]}>
            ...
            source={require('../app/images/pokebola.png')}
            />
            ...
            <SafeAreaView>
                <View style={styles.row}>
                    ...
                    <Text style={[
                        styles.pokemonName,
                        {textAlign:'right', marginRight:20,fontSize:20},
                    ]}>
                        #{currentPokemon.id}
                    </Text>
                </View>
